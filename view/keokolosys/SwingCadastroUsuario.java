...
public class SwingCadastroUsuario extends JFrame implements AbstractGUICadastroDeUsuario{
	...
	private ControleCadastroDeUsuario cadastroDeUsuario;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SwingCadastroUsuario frame = new SwingCadastroUsuario();
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								.addComponent(panel_1, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 449, GroupLayout.PREFERRED_SIZE)
